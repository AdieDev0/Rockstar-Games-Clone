  ...
  return (
    <div className="bg-[#0b0b0b] h-auto text-white max-w-auto font-Moderustic">
      ...
      <div className="mb-40">
        <div className="lg:px-20 lg:pt-28 lg:mb-7 flex flex-col lg:flex-row gap-7 pt-20 px-10">
          ...
          <div className="border border-zinc-800 lg:w-[430px] w-[300px] rounded-xl bg-black">
            ...
            <div className="p-7 my-5 ">
              ...
              <p className="lg:text-2xl text-xl mt-2 font-semibold">
                New Benefactor Vorschlaghammer Slides into the Los Santos Drift
                Racing Scene
              </p>
            </div>
          </div>
        ...
        {/* 2 */}
        <div className="lg:px-20 pt-2 lg:mb-7 flex flex-col lg:flex-row gap-7 px-10">
          <div className="border border-zinc-800 lg:w-[430px] w-[300px] rounded-xl bg-black">
            <img
            ...
            <div className="p-7 my-5 ">
              ...
              <p className="lg:text-2xl text-xl mt-2 font-semibold">
                Explore Parts Unknown to Earn Collector Bonuses Including Triple
                Rewards on Collectible Set Sales
              </p>
            </div>
          </div>
        ...
        {/* 3 */}
        <div className="lg:px-20 lg:mb-7 flex flex-col lg:flex-row gap-7 pt-2 px-10">
          <div className="border border-zinc-800 lg:w-[430px] w-[300px] rounded-xl bg-black">
            <img
